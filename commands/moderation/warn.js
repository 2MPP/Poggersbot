...
module.exports = {
    ...
    run: async (client, message, args) => {
            ...
            return message.channel.send("You should have **MANAGE_MESSAGES** to use this command!")
          }
          ...
          if(message.mentions.members.first().id === message.guild.owner.id) {
            return message.channel.send("Why did u think that would work... <:thonk:715915147373182987>")
          }
            ...
            if(message.author.id === user.id) {
              return message.channel.send("You can not warn yourself")  
                ...
                if(!reason) {
                    ...
                    if(warnings === 5) {
                        return message.channel.send(`${message.mentions.users.first().username} has reached 5 warnings`)
                      }
